...
// let chk = checking(tokens);


// function checking(newInput){
//     let count = 0;
//     console.log(('CHIKINNNG ', count));
//     let encounteredTokens = []
//     let dx = newInput.length;
...
//            case 'I':
//                   if(newInput.type === 'I' && newInput.value.length === 3){
//                          if(!encounteredTokens.includes(newInput.value)){
                                
//                                 encounteredTokens.push(newInput.value);
//                                 console.log("I", encounteredTokens);
//                          }
//                   }
...
// console.log("CHICKING: ", chk);


  
// if (newInput.some(token => token.type === 'I')) {
//     const iTokens = newInput.filter(token => token.type === 'I');
//     const hasUniqueValues = iTokens.every((token, index) => {       
//         for (let i = 0; i < iTokens.length; i++) {
//             if (i !== index && token.value === iTokens[i].value) {
...
//     if (hasUniqueValues) {
//         console.log("All 'I' tokens have unique values.");
//         procesChk.push(newInput);
